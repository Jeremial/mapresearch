window.BMAP_AUTHENTIC_KEY = "1794637158ef5e181d28a2209c2912a6";
(function() {
    var aa = void 0,
        i = !0,
        n = null,
    ...
    function ba(a) { // setSomething
        return function(b) {
            this[a] = b
        }
    }

    function s(a) { // getSomething
        return function() {
            return this[a]
        }
    }
    ...
    t.H = t.z.H;
    t.lang = t.lang || {};
    t.lang.me = function(a) { // isString
        return "[object String]" == Object.prototype.toString.call(a)
    };
    t.me = t.lang.me;
    t.z.xg = function(a) { // selectElement
        return t.lang.me(a) ? document.getElementById(a) : a
    };
    t.xg = t.z.xg;
    t.z.contains = function(a, b) { // containElement
        var c = t.z.xg,
            a = c(a),
            b = c(b);
    ...
    t.z.jv = ia;// Util.jv
    t.z.ru = function(a, b, c) { // setStyle or css
        a = t.z.R(a);
    ...
    t.ru = t.z.ru;
    t.z.su = function(a, b) { // setStyleObject
        var a = t.z.R(a),
            c;
    ...
    t.ri = t.rh.ri;
    t.z.Ob = function(a, b) { // removeClass
    ...
    t.Ob = t.z.Ob;
    t.z.Et = function(a, b, c) { // insertElement
        var a = t.z.R(a),
            d;
    ...
    t.Et = t.z.Et;
    t.z.show = function(a) { // show
        a = t.z.R(a);
        a.style.display = "";
        return a
    };
    t.show = t.z.show;
    t.z.Ys = function(a) { // getDocument
        a = t.z.R(a);
        return a.nodeType == 9 ? a : a.ownerDocument || a.document
    };
    t.z.Ya = function(a, b) { // addClass
    ...
    t.z.Qh.filter = function(a, b, c) {
        for (var d = 0, e = t.z.Qh, f; f = e[d]; d++)
            if (f = f[c]) b = f(a, b);
        return b
    };
    t.rh.FA = function(a) { // toCamelCase
        return a.indexOf("-") < 0 && a.indexOf("_") < 0 ? a : a.replace(/[-_][^-_]/g, function(a) {
            return a.charAt(1).toUpperCase()
        })
    };
    t.z.YL = function(a, b) { // toggleClass
        t.z.zt(a, b) ? t.z.Ob(a, b) : t.z.Ya(a, b)
    };
    t.z.zt = function(a) { // hasClass
    ...
    t.z.kg = function(a, b) {
        var c = t.z,
            ...
            d = a.style[b];
        if (!d) var e = c.Jr[b],
        d = a.currentStyle || (t.M.S ? a.style : getComputedStyle(a, n)), d = e && e.get ? e.get(a, d) : d[e || b];
        if (e = c.Qh) d = e.filter(b, d, "get");
        return d
    };
    t.kg = t.z.kg;
    /opera\/(\d+\.\d)/i.test(navigator.userAgent) && (t.M.opera = +RegExp.$1);
    t.M.lz = /webkit/i.test(navigator.userAgent); // webkit
    t.M.BH = /gecko/i.test(navigator.userAgent) && !/like gecko/i.test(navigator.userAgent); // geocko
    ...
    /firefox\/(\d+\.\d)/i.test(navigator.userAgent) && (t.M.uf = +RegExp.$1);
    ...
    t.lang.gm = function(a) { // isFunction
        return "[object Function]" == Object.prototype.toString.call(a)
    };
    t.lang.ua = function(a) { // addeventlistener removeeventlistener disevent
        this.L = a || t.lang.L();
        window[t.L]._instances[this.L] = this
    };
    window[t.L]._instances = window[t.L]._instances || {};
    t.lang.ua.prototype.rf = fa(1);
    t.lang.ua.prototype.toString = function() {
        return "[object " + (this.IB || "Object") + "]"
    };
    t.lang.Sp = function(a, b) { // L
        this.type = a;
        this.returnValue = i;
        this.target = b || n;
    ...
    t.lang.ua.prototype.addEventListener = function(a, b, c) {
        if (t.lang.gm(b)) {
            !this.Mf && (this.Mf = {}); // eventHandleCache
            var d = this.Mf,
                e;
    ...
    t.lang.ua.prototype.removeEventListener = function(a, b) {
        ...
        else if (!t.lang.me(b)) return;
        !this.Mf && (this.Mf = {});
        a.indexOf("on") != 0 && (a = "on" + a);
        var c = this.Mf;
        c[a] && c[a][b] && delete c[a][b]
    };
    t.lang.ua.prototype.dispatchEvent = function(a, b) { // lng.me = isString
        t.lang.me(a) && (a = new t.lang.Sp(a));
        !this.Mf && (this.Mf = {});
        var b = b || {}, c;
        for (c in b) a[c] = b[c];
        var d = this.Mf,
    ...
    t.lang.ia = function(a, b, c) { // 继承算法 inherit
    ...
    t.platform.FH = /macintosh/i.test(navigator.userAgent); // mac
    t.platform.mz = /windows/i.test(navigator.userAgent); // window
    t.platform.LH = /x11/i.test(navigator.userAgent); // x11
    t.platform.Tj = /android/i.test(navigator.userAgent); // android
    ...
    function qa(a /* mapId */, b /* options */) { // Map
        if (a = t.R(a)) {
            var c = this;
            t.lang.ua.call(c);
            b = b || {};
            ...
            /* android */t.platform.Tj && 1.5 < window.devicePixelRatio && (c.F.devicePixelRatio = 1.5);
            for (var d = c.F.VE, e = 0, f = d.length; e < f; e++)
                if (t.M[d[e]]) {
            ...
            c.Bd = c.platform.firstChild;
            c.Bd.style.width = c.width + "px";
            c.Bd.style.height = c.height + "px";
            c.Gc = {};
            c.De = new F(0, 0);
            c.Lb = new F(0, 0);
            c.la = 1;
            ...
            c.D.ju = e;
            c.N(); // watch on map resize event
            G.load("map", function() {
                // console.log('incallback')
                c.Tb() // module's function
            });
            ...
            za() && G.load("oppc", function() { // mac || window || x11
                c.fq()
            });
            H() && G.load("opmb", function() { // android || iphone || ipad
                c.fq()
            });
            a = n;
            c.Or = []
    ...
    t.extend(qa.prototype, {
        ta: function() { // initContainer
            var a = J("div"), // createElement
                b = a.style;
            b.overflow = "visible";
            b.position = "absolute";
            b.zIndex = "0";
        ...
        N: function() {
            ...
            a.F.Go && (a.D.wl = setInterval(a.tl, 80)) // watch_on mapresize
        },
        Ig: function(a, b, c, d) {
            var e = this.ha().Gb(this.U()),
                f = this.Pc,
                g = i;
            c && F.cz(c) && (this.De = new F(c.lng, c.lat), g = o);
            if (c = c && d ? f.Ii(c, this.zb) : this.Lb)
                if (this.Lb = new F(c.lng + a * e, c.lat - b * e), (a = f.eh(this.Lb, this.zb)) && g) this.De = a
        },
        We: function(a, b) { // zoomTo
            if (Ba(a) && (a = this.jj(a).zoom, a != this.la)) {
                this.Zb = this.la;
                this.la = a;
                var c;
                b ? c = b : this.Je() && (c = this.Je().ba());
        ...
        Ed: function(a) { // setZoom
            this.We(a)
        },
        Qu: function(a) { // zoomIn
            this.We(this.la + 1, a)
        },
        Ru: function(a) { // zoomOut
            this.We(this.la - 1, a)
        },
        qe: function(a) { // panTo -> override in map.js
            a instanceof F && (this.Lb = this.Pc.Ii(a, this.zb), this.De = F.cz(a) ? new F(a.lng, a.lat) : this.Pc.eh(this.Lb, this.zb))
        },
        pe: function(a, b) { // panBy -> override in map.js
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
            this.Ig(-a, -b)
        },
        ho: function(a) { // addControl
            a && Ca(a.Ld) && (a.Ld(this), this.dispatchEvent(new L("onaddcontrol", a)))
        },
        bA: function(a) { // removeControl
            a && Ca(a.remove) && (a.remove(), this.dispatchEvent(new L("onremovecontrol", a)))
        },
        zj: function(a) { // addContextMenu
            a && Ca(a.sa) && (a.sa(this), this.dispatchEvent(new L("onaddcontextmenu", a)))
        },
        ck: function(a) { // removeContextMenu
            a && Ca(a.remove) && (this.dispatchEvent(new L("onremovecontextmenu", a)), a.remove())
        },
        Ua: function(a) { // addOverlay
            a && Ca(a.Ld) && (a.Ld(this), this.dispatchEvent(new L("onaddoverlay", a)))
        },
        Qc: function(a) { // removeOverlay
            a && Ca(a.remove) && (a.remove(), this.dispatchEvent(new L("onremoveoverlay", a)))
        },
        Nx: function() { // clearOverlays
        ...
        re: function(a) { // setCenter
            var b = this;
            if (a instanceof F) b.qe(a, {
                noAnimation: i
            });
            else if (Da(a))
                if (b.vb == ta) {
                    ...
                    var d = this.bw();
                    d.xu(function(c) {
                        0 == d.Bi() && 2 == d.ma.result.type && (b.re(c.Vg(0).point), ta.Hj(a) && b.uu(a))
                    });
                    d.search(a, {
                        log: "center"
                    })
        ...
        Rd: function(a, b) { // centerAndZoom
            ...
            if (a instanceof F && b) {
                ...
                c.Zb = c.la || b;
                c.la = b;
                c.De = new F(a.lng, a.lat);
                c.Lb = c.Pc.Ii(c.De, c.zb);
                c.ks = c.ks || c.la;
                c.js = c.js || c.De;
                var d = new L("onload"),
                    f = new L("onloadcode");
                d.point = new F(a.lng, a.lat);
                d.pixel = c.kb(c.De, c.la);
                d.zoom = b;
        ...
        Qe: function(a, b) { // pointToOverlayPixel
            if (a) {
        ...
        Uz: function(a, b) { // overlayPixelToPoint
            if (a) {
                var c = new O(a.x, a.y);
                c.x += this.offsetX;
                c.y += this.offsetY;
        ...
        EL: function(a, b) {
            var c = this,
                d = map.zb;
            c.vb == ta && d && Ha.Sx(a, c, function(a) {
                a.x -= c.offsetX;
                a.y -= c.offsetY;
                b && b(a)
            })
        ...
        Wo: function(a, b) { // getViewport
            ...
            var d = [];
            a instanceof Ia ? (d.push(a.ke()), d.push(a.le())) : d = a.slice(0);
            for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.Pc.Ii(d[f], this.zb));
            d = new Ia;
        ...
        jt: function() { // getOverlays
            var a = [],
                b = this.ea,
                c = this.Xc;
            if (b)
                for (var d in b) b[d] instanceof Q && a.push(b[d]);
            if (c) {
                d = 0;
        ...
        $g: da(o), // highResolutionEnabled
        ko: function(a, b) { // addHotspot
            b ? this.ff[b] || (this.ff[b] = {}) : b = "custom";
            a.tag = b;
            a instanceof Ka && (this.ff[b][a.L] = a, a.sa(this));
            var c = this;
            G.load("hotspot", function() {
                c.fq()
            })
        },
        sI: function(a, b) { // removeHotspot
            b || (b = "custom");
            this.ff[b][a.L] && delete this.ff[b][a.L]
        },
        di: function(a) { // clearHotspots
            a || (a = "custom");
            this.ff[a] = {}
        },
        lq: function() {
        ...
        hx: function() {
            this.lq();
            var a = this.F;
            this.la < a.mc ? this.Ed(a.mc) : this.la > a.jd && this.Ed(a.jd);
        ...
        lA: function(a) {
            if (a && (a.styleId ? this.Ny(a.styleId) : (this.F.lc = a, this.dispatchEvent(new L("onsetcustomstyles", a)), this.Zy(a.controls), this.$y(this.F.lc.geotableId)), a.style)) a = this.F.qf[a.style] ? this.F.qf[a.style].backColor : this.F.qf.normal.backColor, this.Ba().style.backgroundColor = a
        },
        Ny: function(a) {
            var b = this;
        ...
        $y: function(a) {
            a ? this.Fl && this.Fl.be == a || (this.Ff(this.Fl), this.Fl = new Qa({
                geotableId: a
            }), this.of(this.Fl)) : this.Ff(this.Fl)
        },
        Dc: function() {
    ...
    function Va(a) { // animation class
        var b = {
            duration: 1E3,
            fd: 30, // fps
            Pg: 0, // delay
            Wd: Wa.uz, // easingmethod
            Yt: q()
        };
        this.Xd = []; // 动画队列
        if (a) // merge options
    ...
    Va.prototype.start = function() {
        this.an = Ea(); // startTime
        this.Bq = this.an + this.m.duration; // endtime
        Ya(this)
    };
    ...
    function Ya(a) {
        var b = Ea();
        b >= a.Bq ? // 超过动画时间,直接设置为完成状态
        (
            Ca(a.m.ta) && a.m.ta(a.m.Wd(1)),
            Ca(a.m.finish) && a.m.finish(),
            0 < a.Xd.length && (b = a.Xd[0], b.Xd = [].concat(a.Xd.slice(1)), b.start())
        )
        :
        ( // 还没有完成, 计算完成比例
            a.zp = a.m.Wd((b - a.an) / a.m.duration), Ca(a.m.ta) && a.m.ta(a.zp),
            a.Fu || (a.rl = setTimeout(function() {
            Ya(a)
            }, 1E3 / a.m.fd))
        )
    }
    Va.prototype.stop = function(a) {
        this.Fu = i; // isFinished
        for (var b = 0; b < this.Xd.length; b++) this.Xd[b].stop(), this.Xd[b] = n;
        this.Xd.length = 0;
    ...
    var Wa = { // tween animation
        ...
        As: function(a) { // ease-in
            return a * a
        },
        eG: function(a) {
            return Math.pow(a, 3)
        },
        gG: function(a) { // ease-out
            return -(a * (a - 2))
        },
        fG: function(a) {
    ...
    function bb(a, b) { // insertElement
        t.z.Et(a, "beforeEnd", b);
        return a.lastChild
    }

    function cb(a) { // getOffset
        for (var b = {
            left: 0,
            top: 0
    ...
    function db(a) { // preventDefault
        a = window.event || a;
        a.preventDefault ? a.preventDefault() : a.returnValue = o;
        return o
    }

    function ka(a) { // wrap the event
        A(a);
        return db(a)
    }

    function eb() { // getScrollPosition
    ...
    function J(a, b, c) { // createElement
        var d = document.createElement(a);
        c && (d = document.createElementNS(c, a));
        return t.z.su(d, b || {})
    }

    function Aa(a) { // getStyle
        if (a.currentStyle) return a.currentStyle;
        if (a.ownerDocument && a.ownerDocument.defaultView) return a.ownerDocument.defaultView.getComputedStyle(a, n)
    }

    function Ca(a) { // isFunction
        return "function" == typeof a
    }

    function Ba(a) { // isNumber
        return "number" == typeof a
    }

    function Da(a) { // isString
        return "string" == typeof a
    }

    function hb(a) { // isnt undefined
        return "undefined" != typeof a
    }

    function jb(a) { // isObject
    ...
    function lb(a) {
        ...
        do c = kb.indexOf(a.charAt(j++)), d = kb.indexOf(a.charAt(j++)), f = kb.indexOf(a.charAt(j++)), g = kb.indexOf(a.charAt(j++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(c), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e)); while (j < a.length);
        return b
    }
    var L = t.lang.Sp; // 自定义事件类

    function H() { // android || iphone || ipad
        return !(!t.platform.EH && !t.platform.DH && !t.platform.Tj)
    }

    function za() { // mac || windows || x11
    ...
    function nb() { // supportShape
        return !!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Shape", "1.1")
    }

    function ob() { // supportCanvas
        return !!J("canvas").getContext
    };

    function La(a, b) { // 异步请求模块部分
        if (b) { // 需要添加回调函数
    ...
    var pb = {
        ...
        navictrl: "0cm0nn",
        geoctrl: "xlg2bu",
        copyrightctrl: "l0nf1c",
        scommon: "nqn0ho",
        local: "yygla0",
        route: "kakko3",
        othersearch: "5o2cpe",
        mapclick: "wdtpis",
        buslinesearch: "izr4vp",
        hotspot: "cjh5es",
        autocomplete: "zgu0bd",
        coordtrans: "wad4d0",
    ...
    t.Jp = function() {
        ...
        var b = "BMap_",
            ...
            d = "localStorage" in window && c !== n && c !== aa; // aa == undefined
        return {
            IH: d,
            set: function(a, f) {
                if (d) {
    ...
    t.object.extend(G, {
        ...
        HL: {},
        Vu: {
            vB: '/modules.js?debug=1',
            // vB: "http://api0.map.bdimg.com/getmodules?v=2.0",
            zE: 5E3
        },
        ls: o, // isLoading? false
        rc: {
            Gh: {},
            dj: [], // 请求队列
            Vn: []
        ...
        load: function(a, b, c) {
            var d = this.El(a); // 初始化名字及存储位置
            if (d.vc == this.rg.tk) c && b(); // 已经加载完毕了
            else {
                if (d.vc == this.rg.av) { // 还没有加载
                    this.Px(a); // 查看有没有依赖关系
                    this.$z(a); // 加入请求队列
                    var e = this;
                    e.ls == o && (e.ls = i, setTimeout(function() {
                        for (var a = [], b = 0, c = e.rc.dj.length; b < c; b++) {
                            var d = e.rc.dj[b],
                                l = "";
                            // ha.Jp.Jx -> Line 1542
                            // 查看localStorage 是否已经有module

                            // 注释下行, 使得每次都从服务器获取最新的module
                            // ha.Jp.Jx(d) ? l = ha.Jp.get(d) :
                            (l = "", a.push(d + "_" + pb[d]));
                            e.rc.Vn.push({
                                Gz: d,
                                St: l
                        ...
                        e.ls = o;
                        e.rc.dj.length = 0; // 清空请求队列
                        0 == a.length ? e.oy()  // 没有要请求的队列
                        : La(e.Vu.vB + "&mod=" + a.join(",")) // 异步请求
                    }, 1));
                    d.vc = this.rg.nB
                }
                d.bn.push(b) // 缓存callback
            }
        },
        Px: function(a) { // 查看依赖关系 checkDependency
            if (a && this.Ay()[a])
                for (var a = this.Ay()[a], b = 0; b < a.length; b++) this.Px(a[b]), this.rc.Gh[a[b]] || this.$z(a[b])
        },
        $z: function(a) { // 加入请求队列
            for (var b = 0; b < this.rc.dj.length; b++)
                if (this.rc.dj[b] == a) return; // 已经在请求队列里面了
            this.rc.dj.push(a)
        },
        CI: function(a, b) { // handle module
            var c = this.El(a);
            try {
                eval(b)
            } catch (d) {
            ...
            c.vc = this.rg.tk;// 设置已经load完毕
            for (var e = 0, f = c.bn.length; e < f; e++) c.bn[e]();
            c.bn.length = 0 // 调用回调函数后,将回调队列清空.
        },
        Jx: function(a, b) {
            var c = this;
        ...
        El: function(a) {
            this.rc.Gh[a] || (this.rc.Gh[a] = {}, this.rc.Gh[a].vc = this.rg.av, this.rc.Gh[a].bn = []);
            return this.rc.Gh[a]
        },
        remove: function(a) {
            delete this.El(a)
        },
        gF: function(a, b) { // 缓存module
            for (var c = this.rc.Vn, d = 0, e = c.length; d < e; d++)
                if ("" == c[d].St)
                    if (c[d].Gz == a) c[d].St = b;
                    else return;
            this.oy()
        },
        oy: function() { // load module
            for (var a = this.rc.Vn, b = 0, c = a.length; b < c; b++) this.CI(a[b].Gz, a[b].St);
            this.rc.Vn.length = 0
        }
    });

    function O(a, b) { // Pixel
        this.x = a || 0;
        this.y = b || 0;
        this.x = this.x;
        this.y = this.y
    ...
    function Ka(a, b) { // Hotspot
        a && (this.ze = a, this.L = "spot" + Ka.L++, b = b || {}, this.Xf = b.text || "", this.Mn = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.ix = b.userData || n, this.hf = b.minZoom || n, this.Od = b.maxZoom || n)
    }
    Ka.L = 0;
    t.extend(Ka.prototype, {
        sa: function(a) {
            this.hf == n && (this.hf = a.F.mc);
            this.Od == n && (this.Od = a.F.jd)
        },
        ga: function(a) { // setPosition
            a instanceof F && (this.ze = a)
        },
        ba: s("ze"), // getPosition
        Dm: ba("Xf"), // setText
        ut: s("Xf"), // getText
    ...
    function Ma(a) { // NavigationControl
        R.call(this);
        a = a || {};
        this.m = {
            Se: o,
    ...
    function tb(a) { // GeolocationControl
        R.call(this);
        a = a || {};
        this.m = {
            anchor: a.anchor,
    ...
    function ub(a) { // CopyrightControl
        R.call(this);
        a = a || {};
        this.m = {
            Se: o,
    ...
    t.object.extend(ub.prototype, {
        ...
        ui: function(a) { // getCopyright
            for (var b = 0, c = this.eb.length; b < c; b++)
                if (this.eb[b].id == a) return this.eb[b]
        },
        Ws: s("eb"), // getCopyrightCollection
        ku: function(a) { // removeCopyright
            for (var b = 0, c = this.eb.length; b < c; b++) this.eb[b].id == a && (r = this.eb.splice(b, 1), b--, c = this.eb.length)
        },
        Id: function() {
            var a = this;
    ...
    function Oa(a) { // OverviewMapControl
        R.call(this);
        a = a || {};
        this.m = {
            Se: o,
    ...
    function Na(a) { // ScaleControl
        ...
        this.lf[this.m.Qb] || (this.m.Qb = "metric");
        this.Ow = n;
        this.xw = {};
        this.Id()
    }
    ...
    t.object.extend(Na.prototype, {
        ...
        zu: function(a) { // setUnit
            this.m.Qb = this.lf[a] && this.lf[a].name || this.m.Qb
        },
        fH: function() { // getUnit
            return this.m.Qb
        },
    ...
    function Pa(a) { // MapTypeControl
        ...
        this.Pb(a.anchor);
        "[object Array]" == Object.prototype.toString.call(a.mapTypes) && (this.m.Oe = a.mapTypes.slice(0));
        this.Id()
    }
    ...
    t.object.extend(Ab.prototype, {
        ...
        lo: function(a) { // addItem
            if (a && !("menuitem" != a.tb || "" == a.Xf || 0 >= a.BE)) {
        ...
        removeItem: function(a) {
            if (a && "menuitem" == a.tb) {
                ...
                b = 0;
                for (c = this.Pd.length; b < c; b++) this.Pd[b] === a && (this.Pd[b].remove(), this.Pd.splice(b, 1), c--)
            }
        },
        Qr: function() { // addSeparator
            this.da.push({
                tb: "divider",
                vg: this.Yc.length
            });
        ...
        lu: function(a) { // removeSeparator
            if (this.Yc[a]) {
                for (var b = 0, c = this.da.length; b < c; b++) this.da[b] && ("divider" == this.da[b].tb && this.da[b].vg == a) && (this.da.splice(b, 1), c--), this.da[b] && ("divider" == this.da[b].tb && this.da[b].vg > a) && this.da[b].vg--;
                this.Yc.splice(a, 1)
            }
        },
        gd: s("B"),
    ...
    t.object.extend(Ia.prototype, {
        ...
        pb: function(a) { // equals
            return !(a instanceof Ia) || this.mg() ? o : this.le().pb(a.le()) && this.ke().pb(a.ke())
        },
        le: s("Sh"), // getSouthWest
        ke: s("Jh"), // getNorthEast
        sF: function(a) { // containsBounds
            return !(a instanceof Ia) || this.mg() || a.mg() ? o : a.dd > this.dd && a.ad < this.ad && a.cd > this.cd && a.$c < this.$c
        },
        Ga: function() { // getCenter
            return this.mg() ? n : new F((this.dd + this.ad) / 2, (this.cd + this.$c) / 2)
        },
        az: function(a) { // intersects
    ...
    F.cz = function(a) { // Point.isValid(point)
        return a && 180 >= a.lng && -180 <= a.lng && 74 >= a.lat && -74 <= a.lat
    };
    F.prototype.pb = function(a) { // equal
        return a && this.lat == a.lat && this.lng == a.lng
    };

    function Cb() {} // Projection
    Cb.prototype.mm = function() {
        throw "lngLatToPoint\u65b9\u6cd5\u672a\u5b9e\u73b0"; // 方法未实现
    };
    ...
    t.extend(P, {
        ...
        WK: function(a, b) {
            ...
            d = this.th(a.lat);
            b = this.ib(b);
            return !b ? 0 : this.xd(c, this.th(b.lng), d, this.th(b.lat))
        },
        Xs: function(a, b) {
            if (!a || !b) return 0;
            ...
            return this.xd(this.th(a.lng), this.th(b.lng), this.th(a.lat), this.th(b.lat))
        },
        ib: function(a) {
            var b, c;
            b = new F(Math.abs(a.lng), Math.abs(a.lat));
            for (var d = 0; d < this.dv.length; d++)
                if (b.lat >= this.dv[d]) {
                    c = this.aB[d];
                    break
                }
        ...
        ob: function(a) {
            ...
            a.lat = this.lt(a.lat, -74, 74);
            b = new F(a.lng, a.lat);
            for (var d = 0; d < this.Xm.length; d++)
                if (b.lat >= this.Xm[d]) {
                    c = this.bv[d];
                    break
                }
            if (!c)
                for (d = this.Xm.length - 1; 0 <= d; d--)
                    if (b.lat <= -this.Xm[d]) {
                        c = this.bv[d];
                        break
                    }
    ...
    t.extend(P.prototype, {
        ...
        $j: function(a) { // pointToLngLat
            a = new F(a.x, a.y);
            return P.ib(a)
        },
        kb: function(a, b, c, d, e) {
            if (a) return a = this.Ii(a, e), b = this.Gb(b), new O(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((c.lat - a.lat) / b + d.height / 2))
        },
        Sa: function(a, b, c, d, e) {
            if (a) return b = this.Gb(b), this.eh(new F(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e)
        },
        Gb: function(a) {
    ...
    function Ja() { // PerspectionProjection
        this.fs = "bj"
    }
    Ja.prototype = new P;
    ...
    B.ld(function(a) {
        ...
        a.addEventListener("addoverlay", function(a) {
            ...
            if (a instanceof Q) b.ea[a.L] || (b.ea[a.L] = a);
                ...
                for (var d = o, e = 0, f = b.Xc.length; e < f; e++)
                    if (b.Xc[e] === a) {
                        d = i;
                        break
                    }
        ...
        a.addEventListener("removeoverlay", function(a) {
            ...
            if (a instanceof Q) delete b.ea[a.L];
                ...
                for (var d = 0, e = b.Xc.length; d < e; d++)
                    if (b.Xc[d] === a) {
                        b.Xc.splice(d, 1);
                        break
                    }
    ...
    function Gb(a) {
        ...
        this.w = {
            ...
            Ue: a.strokeWeight || 5,
            te: a.strokeOpacity || 0.65,
            strokeStyle: a.strokeStyle || "solid",
            Sg: a.enableMassClear === o ? o : i,
            Ug: n,
            zi: n,
            Td: a.enableEditing === i ? i : o,
            Jz: 15,
            JJ: o,
            rd: a.enableClicking === o ? o : i
        };
        0 >= this.w.Ue && (this.w.Ue = 5);
        if (0 > this.w.te || 1 < this.w.te) this.w.te = 0.65;
    ...
    Gb.Po = function(a) {
        var b = [];
        if (!a) return b;
        Da(a) && t.hc.Sd(a.split(";"), function(a) {
            a = a.split(",");
    ...
    t.extend(Gb.prototype, {
        ...
        Ye: function() {
            if (this.W) {
                var a = this;
                a.gq = new Ia;
                t.hc.Sd(this.W, function(b) {
                    a.gq.extend(b)
                })
            }
        },
        Kc: s("W"), // getPath
        Vi: function(a, b) { // setPositionAt
            b && this.W[a] && (this.od.length = 0, this.W[a] = new F(b.lng, b.lat), this.Ye())
        },
        setStrokeColor: function(a) {
            this.w.strokeColor = a
        },
        WG: function() { // getStrokeColor
            return this.w.strokeColor
        },
        Cm: function(a) { // setStrokeWeight
            0 < a && (this.w.Ue = a)
        },
        My: function() { // getStrokeWeight
            return this.w.Ue
        },
        Am: function(a) { // setStrokeOpacity
            a == aa || (1 < a || 0 > a) || (this.w.te = a)
        },
        XG: function() { // getStrokeOpacity
            return this.w.te
        },
        Ap: function(a) { // setFillOpacity
            1 < a || 0 > a || (this.w.qi = a)
        },
        CG: function() { // getFillOpacity
            return this.w.qi
        },
        Bm: function(a) { // setStrokeStyle
            "solid" != a && "dashed" != a || (this.w.strokeStyle = a)
        },
        Ly: function() { // getStrokeStyle
    ...
    t.extend(Hb.prototype, {
        Bk: function() {
            ...
            c.push(b);
            c.push("</div>");
            this.J = bb(this.map.Le().Qt, c.join(""))
        },
        initialize: function(a) {
            this.map = a;
            this.Bk();
    ...
    t.extend(Ib.prototype, {
        TI: function(a) { // setImageUrl
            a && (this.imageUrl = a)
        },
        dJ: function(a) { // setPrintImageUrl
    ...
    t.extend(Jb.prototype, {
        ...
        $b: function(a) { // setTitle
            this.w.title = a
        },
        getTitle: function() {
            return this.w.title
        },
        Bc: ba("content"), // setContent
        yy: s("content"), // getContent
        ym: function(a) { // setMaxContent
            this.w.Rt = a + ""
        },
        Ac: q(), // redraw
        Nl: function() { // enableAutoPan
            this.w.Nl = i
        },
        ...
        Ge: function() { // enableMaximize
            this.w.Ge = i
        },
        Eo: function() { // disableMaximize
            this.w.Ge = o
        },
        show: function() {
            this.sb = i
    ...
    function Kb(a, b) { // Label
        ...
        hb(b.enableClicking) && (this.w.rd = b.enableClicking);
    ...
    t.extend(Kb.prototype, {
        ...
        oc: function(a) { // setStyle
            a = a || {};
            this.w.mk = t.extend(this.w.mk, a)
        },
        oh: function(a) { // setStyles
            return this.oc(a)
        },
        $b: function(a) { // setTitle
            this.w.title = a || ""
    ...
    t.extend(S.prototype, {
        Gf: function(a) { // setIcon
            a instanceof Ib && (this.w.Me = a)
        },
        Ey: function() { // getIcon
            return this.w.Me
        },
        Ep: function(a) { // setShadow
            a instanceof Ib && (this.w.ph = a)
        },
        getShadow: function() {
            return this.w.ph
        },
        Ti: function(a) { // setLabel
            this.w.label = a || n
        },
        Fy: function() { // getLabel
            return this.w.label
        },
        Ab: function() { // enableDragging
            this.w.Ab = i
        },
        ns: function() { // disableDragging
            this.w.Ab = o
        },
        ba: s("O"), // getPosition
        ga: function(a) { // setPosition
        ...
        Si: ba("Dk") // setAnimation
    });

    function Nb(a, b) { // Polygon
        Gb.call(this, b);
        b = b || {};
    ...
    t.extend(Nb.prototype, {
        ...
        Vi: function(a, b) { // setPositionAt
            this.wj[a] && (this.wj[a] = new F(b.lng, b.lat), this.W[a] = new F(b.lng, b.lat), 0 == a && !this.W[0].pb(this.W[this.W.length - 1]) && (this.W[this.W.length - 1] = new F(b.lng, b.lat)), this.Ye())
        },
        Kc: function() { // getPath
            var a = this.wj;
            0 == a.length && (a = this.W);
    ...
    t.extend(Sb.prototype, {
        ...
        we: function() {
            ...
            0 == this.gh && (this.Pf && (clearTimeout(this.Pf), this.Pf = n), this.Pf = setTimeout(function() {
                if (a.gh == 0) {
        ...
        Oj: function(a, b, c) {
            ...
            for (this.If ? this.If.length = 0 : this.If = []; l < p; l++)
                for (var w = m; w < u; w++) {
                    var y = l,
                        E = w;
                    this.If.push([y, E]);
            ...
            l = 0;
            for (d = a.childNodes.length; l < d; l++) w = a.childNodes[l], w.mw = o, this.$h.push(w);
            if (l = this.Wt)
                for (var x in l) delete l[x];
            else this.Wt = {};
            this.ai ? this.ai.length = 0 : this.ai = [];
            l = 0;
            for (d = this.If.length; l < d; l++) {
                x = this.If[l][0];
                j = this.If[l][1];
                w = 0;
                for (m = this.$h.length; w < m; w++)
                    if (p = this.$h[w], p.id == k + "_" + b + "_" + x + "_" + j + "_" + f) {
                        p.mw = i;
                        this.Wt[p.id] = p;
                        break
                    }
        ...
        iJ: function(a, b, c, d) {
            ...
            var f = this.map.ha(),
                ...
                k = this.ne[g];
            k && k.Ta ? (Za(k.Ta, b), d && (d = new O(a[0], a[1]), f = this.map.F.lc ? this.map.F.lc.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = o, Ub(k, d)), k.loaded ? this.we() : Vb(k, function() {
                e.we()
            })) : (k = this.dg[g]) && k.Ta ? (c.cb.insertBefore(k.Ta, c.cb.lastChild), this.ne[g] = k, Za(k.Ta, b), d && (d = new O(a[0], a[1]), f = this.map.F.lc ? this.map.F.lc.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = o, Ub(k, d)), k.loaded ? this.we() : Vb(k, function() {
                e.we()
            })) : (k = j * Math.pow(2, f.xi() - a[2]), new F(a[0] * k, a[1] * k), d = new O(a[0], a[1]), f = this.map.F.lc ? this.map.F.lc.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Wb(this, d, b, a, c), Vb(k, function() {
                e.we()
            }), Xb(k), this.ne[g] = k)
        },
        we: function() {
        ...
        Pe: function(a) {
            ...
            if (b.map.ha() == ta) G.load("coordtrans", function() {
                ...
                if (a && a)
                    for (var c in this.dg) delete this.dg[c];
                b.uw(a)
            }
        },
        uw: function(a) {
            for (var b = this.Wj.concat(this.Vd), c = b.length, d = 0; d < c; d++) {
                var e = b[d];
                ...
                if (e.po) {
                    ...
                    if (a) {
                        var g = f;
                        if (g && g.childNodes)
                            for (var j = g.childNodes.length, k = j - 1; 0 <= k; k--) j = g.childNodes[k], g.removeChild(j), j = n
                    }
                    if (this.map.Dc()) {
                        ...
                        continue
                    } else f.style.display = "block", this.fe.style.display = "none", this.map.dispatchEvent(new L("vectorchanged"), {
                        isvector: o
                    })
                }
                if (!(e.Uj && !this.map.Dc() || e.iz && this.map.Dc())) {
                    var l = this.map,
                        ...
                        j = l.la,
                        p = l.Lb;
                    m == ta && p.pb(new F(0, 0)) && (p = l.Lb = f.Ii(l.De, l.zb));
                    var u = m.Gb(j),
                        j = m.Py(j),
                        f = Math.ceil(p.lng / j),
                        g = Math.ceil(p.lat / j),
                    ...
                    for (E in y) {
                        var x = y[E],
                            I = x.info;
                        (I[2] != p || I[2] == p && (k > I[0] || g <= I[0] || f > I[1] || m <= I[1])) && this.Xo(x)
                    }
                    ...
                    v = [];
                    for (l.Or = []; k < g; k++)
                        for (w = f; w < m; w++) v.push([k, w]), l.Or.push({
                            x: k,
                            y: w
                        });
                    v.sort(function(a) {
        ...
        pg: function() {
            for (var a = this.Wj, b = 0, c = a.length; b < c; b++) a[b].remove();
            delete this.cb;
            this.Wj = [];
            this.dg = this.ne = {};
            this.Zo();
    ...
    function ac(a) { // VectorTrafficLayer
        a = a || {};
        this.m = t.extend(a, {
            zIndex: 1,
    ...
    function Qa(a, b) { // CustomLayer
        ...
        this.ue.Hu = this;
        jb(a) ? b = a || {} : (c.Nk = a, b = b || {});
        b.geotableId && (c.be = b.geotableId);
    ...
    Qa.prototype.getTilesUrl = function(a, b) {
        ...
        this.be ? c += "&geotable_id=" + this.be : this.Nk && (c += "&databox_id=" + this.Nk);
        return c
    };
    Qa.$D = /^point\(|\)$/ig;
    Qa.aE = /\s+/;
    ...
    t.extend(cc.prototype, {
        ...
        Jj: function() { // getMinZoom
            return this.m.mc
        },
        xi: function() { // getMaxZoom
            return this.m.jd
        },
        $l: function() { // getTextColor
            return this.m.wJ
        },
        Ai: function() { // getProjection
            return this.m.Pc
        },
        XK: function() {
            return this.m.Js
    ...
    var xa = new cc("\u6df7\u5408", [ic, jc], { // 混合
        tips: "\u663e\u793a\u5e26\u6709\u8857\u9053\u7684\u536b\u661f\u5f71\u50cf", // 显示带有街道的卫星影像
        labelText: "\u8def\u7f51", // 路网
        minZoom: 1,
        maxZoom: 19,
        textColor: "white"
    ...
    function V(a, b) {
        ...
        this.m.$.Ce = "undefined" != typeof b && "undefined" != typeof b.renderOptions && "undefined" != typeof b.renderOptions.autoViewport ? b.renderOptions.autoViewport : i;
        this.m.$.wa = t.qc(this.m.$.wa)
    }
    t.ia(V, t.lang.ua);
    t.extend(V.prototype, {
        getResults: function() {
            return this.yb ? this.Nf : this.P
        },
        ...
        Ui: function(a) { // setLocation
            a && (this.fc.src = a)
        },
        xu: function(a) { // setSearchCompleteCallback
            this.m.mp = a || q()
        },
    ...
    var lc = { // { json || jsonp } loader
        fB: "http://api.map.baidu.com/",
        Pa: function(a, b, c, d, e) {
            ...
            d = d || "";
            b = c && c.KA ? gb(b, encodeURI) : gb(b, encodeURIComponent); // makeURI
    ...
    t.extend(Cc.prototype, {
        ...
        toString: da("TransitRoute"), // toString
        mE: function(a) {
            return a.replace(/\(.*\)/, "")
        }
    });
    ...
    function Geolocation(a) { // Geolocation
        this.m = {};
        t.extend(this.m, a);
        this.na = [];
        var b = this;
    ...
    t.extend(Mc.prototype, {
        ...
        search: ba("$f"), // search
        Bp: ba("lw") // setInputValue
    });
    var ya;

    function sa(a, b) { // Panorama
    ...
    t.extend(sa.prototype, {
        ...
        aL: s("oD"),
        lh: function(a) { // setId
            a != this.Ub && (this.Ub = a, this.ze = n)
        },
        ga: function(a) { // setPosition
            a.pb(this.ze) || (this.ze = a, this.Ub = n)
        },
        nh: function(a) { // setPov
            this.Fb = a;
            a = this.Fb.pitch;
        ...
        Ed: function(a) { // setZoom
            a != this.ge && (a > Nc && (a = Nc), a < Oc && (a = Oc), a != this.ge && (this.ge = a))
        },
        Cr: function() {
            if (this.A)
        ...
        hG: function() { // enableScrollWheelZoom
            this.m.enableScrollWheelZoom = i
        },
        NF: function() { // disableScrollWheelZoom
    ...
    function zb(a, b) { // PanoramaService
        this.Q = a || n;
        var c = this;
        c.Q && c.N();
        G.load("panorama", function() {
    ...
    t.extend(zb.prototype, {
        ...
        Zl: function(a, b) { // getPanoramaById
            this.Ub = a;
            this.Ze = b;
            this.er = n
        },
        yi: function(a, b) { // getPanoramaByLocation
            this.er = a;
            this.Ze = b;
            this.Ub = n
        }
    ...
    function yb(a) { // PanoramaCoverageLayer
        T.call(this);
    ...
    W(id, {
        addCopyright: id.io,
        removeCopyright: id.ku,
        getCopyright: id.ui,
        getCopyrightCollection: id.Ws
    });
    W(window, {
    ...
    W(jd, {
        getMapType: jd.ha,
        getCopyright: jd.ui,
        isTransparentPng: jd.jm
    });
    var kd = Ab.prototype;
    W(kd, {
        addItem: kd.lo,
        addSeparator: kd.Qr,
        removeSeparator: kd.lu
    });
    var ld = Bb.prototype;
    W(ld, {
        setText: ld.Dm
    ...
    W(md, {
        getStatus: md.Bi,
        setSearchCompleteCallback: md.xu,
        getPageCapacity: md.yd,
        setPageCapacity: md.ik,
        setLocation: md.Ui,
        disableFirstResultSelection: md.os,
        enableFirstResultSelection: md.Es,
        gotoPage: md.Di,
        searchNearby: md.gk,
        searchInBounds: md.Ri,
        search: md.search
    });
    W(window, {
